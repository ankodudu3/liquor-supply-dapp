...
import { idlFactory } from './liquor_supply_dapp.did.js';
export { idlFactory } from './liquor_supply_dapp.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LIQUOR_SUPPLY_DAPP;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./liquor_supply_dapp.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the liquor_supply_dapp canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./liquor_supply_dapp.did.js")._SERVICE>}
 */
export const liquor_supply_dapp = createActor(canisterId);
